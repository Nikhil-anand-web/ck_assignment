  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 p-6">
        ...
        <div className="flex gap-3">
          {product.varient.map((v) => (
            <button
              ...
              className={`px-4 py-2 rounded border transition ${selectedVarient.id === v.id
                ? "bg-[#c4e413] text-white border-[#c4e413]"
      ...
      <div className="space-y-1">
        <div className="text-xl font-semibold text-[#c4e413]">
